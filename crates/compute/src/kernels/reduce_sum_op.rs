...
mod tests {
    ...
    fn mock_reduce_sum_computes_sum() {
        ...
        let output_buffer_view = BufferView::new(output_placeholder, vec![1], std::mem::size_of::<f32>());
        ...
        let result_buffers = cpu.dispatch(&Kernel::ReduceSum, &dispatch_binds, [1,1,1]).expect("Dispatch for ReduceSum failed");
