...
mod tests {
    ...
    fn mock_reduce_max_computes_max_value() {
        ...
        let result_buffers1 = cpu
            .dispatch(&Kernel::ReduceMax, &dispatch_binds1, [1, 1, 1])
        ...
        let result_buffers2 = cpu
            .dispatch(&Kernel::ReduceMax, &dispatch_binds2, [1, 1, 1])
